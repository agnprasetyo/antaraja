...
class DriverController extends Controller
{
    ...
    public function actionUpdate($id)
    {
        ...
        $model['NoHp'] = $model['Driver']['noHps'];
        $model['MerkHp'] = $model['Driver']['merkHps'];
        ...
        $model['NoHp']['nomer1'] = $model['NoHp'][0]->nomer;
        $model['NoHp']['nomer2'] = isset($model['NoHp'][1]) ? $model['NoHp'][1]->nomer : null;
    ...
    public function actionFiles($id)
    {
        if (($model = Driver::findOne($id)) !== null) {
            if ($model->berkas == $model::FLAG_DELETED) {
